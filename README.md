...
On phones, the P&L keeps all ten statement lines on one screen. Its **Values** and **Δ PY** controls switch between PY/Actual amounts and signed absolute/percentage variances without sideways scrolling. Green and red reflect earnings impact, so lower cost is favorable; the desktop cumulative bridge and source-inspection behavior are unchanged.
