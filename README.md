...
On phones, statement overview pages show three complete headline indicators and a visible **All indicators** control instead of clipping additional cards at the viewport edge. The control retains access to every source-tied KPI and calculation.
