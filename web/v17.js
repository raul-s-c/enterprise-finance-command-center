...
renderers['performance-review']=function(){
  ...
  <div class="panel-grid">
    ${panel('Lifecycle trend','Monthly controlled snapshots',FinanceLifecycleVisual.status(actions,trend,table(trend,[{key:'month',label:'Close month'},{key:'active',label:'Active',num:true},{key:'overdue',label:'Overdue',num:true},{key:'carry_forward',label:'Carry-forward',num:true},{key:'closed',label:'Closed',num:true}])), 'span-5')}
