...
(function(root){
  ...
  function waterfall(row,narrow=false){
    ...
    return `<svg class="report-svg bridge-svg" viewBox="0 0 900 390" role="img" aria-label="Revenue to EBIT bridge, EUR million"><line x1="30" x2="895" y1="${zero}" y2="${zero}" class="axis"/>${items.map((r,i)=>{
      const x=42+i*step;
