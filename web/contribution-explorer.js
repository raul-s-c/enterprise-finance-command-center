...
(function(root){
  ...
  api.mount=data=>{
    ...
    function paint(){
      ...
      document.getElementById('cx-method').onclick=()=>reportDialog('Source & coverage',`<div class="help-pages"><p>Source: dashboard.json → ${e(sourceName)}. ${e(def.period)} ending ${e(s.month)}. Sum of ${e(s.metric)} grouped by ${e(s.dimension)}. Signed contribution = contributor / selected total; unavailable when total is zero.</p><p>${e(note(data,key))} Report scope can be adopted only when matching records exist. No missing balance is allocated.</p></div>`);
